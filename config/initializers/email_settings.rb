begin
  if Rails.env.development?
    ...
    raise StandardError, "You need to set up ActionMailer::Base.default_url_options[:host] and other ActionMailer settings for production environment in #{__FILE__}"
